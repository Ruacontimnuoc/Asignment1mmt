class VideoStream:
	...
	def setnextFrameFlag(self):
		self.nextFrameFlag = 1

	def nextFrame(self):
		"""Get next frame."""
		if self.nextFrameFlag == 1:
			forwardFrames = int(self.totalFrame*0.08)
	...
	def prevFrame(self):
		preFrames = int(self.totalFrame * 0.08)

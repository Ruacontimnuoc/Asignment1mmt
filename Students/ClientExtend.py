...
class ClientExtend:
    ...
    def createWidgets(self):
        ...
        self.pause["text"] = "⏸_PAUSE_⏸"
        self.pause["bg"] = "#f7e702"
        self.pause["fg"] = "black"
        ...
        self.totaltimeBox = Label(self.master, width=16, text="Total: 00:00", bg= "#a5d2eb")
        self.totaltimeBox.grid(row=1, column=3, columnspan=1, padx=5, pady=5)

        # Create a label to display remaining time of the movie

        self.remainTimeBox = Label(self.master, width=16, text="Remaining: 00:00", bg="#a5d2eb")
